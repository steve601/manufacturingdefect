# MANUFACTURING DEFECT RATE PREDICTION

## Overview
->Pedicting whether an defects rate of a particular company will be high or low
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/manufacturingdefect.git
    cd manufacturingdefect
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/defect-rate
